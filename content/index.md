---
title: "Welcome to Lumeria: Reclamation"
draft: "false"
description:
tags:
---
...
With the imbalance in [[The Aether]], revivification has become impossible. If you fail your death saves, your character succumbs to the dangers of the [[Shadow-Wastes]].
...
>
>Please respect each others boundaries, keep chat kind, and remember: we're all here to tell a story together, not to test comfort and make people want to stop playing.
>
...
- **Schedule Rule:** Sessions must be scheduled **at least 3 days in advance** to give GMs and players time to prepare. #Aegis (the guild's support bot) will handle event postings and automate registration.

>[!tip] Recording the Reclamation
>The Guild's archives grow only through the Spears who brave the dark. Every expedition generates a thread in the `#session-journal` channel. These serve as the official records of what occurred, what was discovered, and who returned.
>
>Players are responsible for keeping the world's map and campaign history updated. Maps, discoveries, and reports are community-built: the Guild's scribes are whoever picks up the pen.
>
>**Any player who posts a session summary or keeps notes/an updated map in the expedition's thread will receive a 10% experience bonus for that session.**
>
...
>[!danger] The Reclamation Never Sleeps
...
- You'll then get setup to receive the `@GM` role, access to private prep channels, and shared templates/materials for building for your first session in Lumeria.
- New GMs are encouraged to start small and ask for help if feeling lost or overwhelmed.

>[!Success] A Safe Place to Learn
>You don't need to have any past experience to get started. You'll have tons of guidance, tools, and support from other experienced GMs in the Guild. Every #Expedition adds to the world.
>
